...
public class JFDadosVenda extends javax.swing.JFrame {
    ...
    private void loadTable() {
        ...
        model.setItens(ItemDAO.readVendas(v));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFDadosVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFDadosVenda().setVisible(true);
            }
        });
    }
